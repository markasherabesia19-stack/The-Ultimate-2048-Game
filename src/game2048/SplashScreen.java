...
/**
 * SplashScreen is the main menu screen of the game.
 * Displays the game title, animated background with stars, and navigation buttons for New Game, How to Play, and Leaderboard.
 */
public class SplashScreen extends JPanel {
    ...
    private void startAnimations() {
        animationTimer = new Timer(30, e -> {
            // Speed up title fade-in 
            titleAlpha = Math.min(1f, titleAlpha + 0.05f);
            if (titleAlpha >= 1f) {
                // Speed up button fade-in
                buttonAlpha = Math.min(1f, buttonAlpha + 0.08f);
            }
    ...
    private void drawButton(Graphics2D g2d, Rectangle bounds, String text, Color baseColor) {
        ...
        // Button text - consistent font size
        g2d.setColor(Color.WHITE);
    ...
    public void removeNotify() {
        ...
        System.out.println("SplashScreen: Stopping animation timer");
    
        if (animationTimer != null && animationTimer.isRunning()) {
            animationTimer.stop();
            System.out.println("SplashScreen timer stopped");
        }
    }
}