 ...
 * Manages the grid of tiles, handles move operations in all four directions,
 * tracks score, win condition, and provides game state queries like game over detection.
 */
public class Board {
    ...
    public void addRandomTile() {
        ...
        // Add a tile to a random empty cell
        ...
        for (int row = 0; row < size; row++) {
            ...
            for (int col = 0; col < size; col++) {
                if (grid[row][col] != null) {
                    ...
                    // Try to merge with tile to the left
        ...
        for (int row = 0; row < size; row++) {
            ...
            for (int col = size - 1; col >= 0; col--) {
                if (grid[row][col] != null) {
                    ...
                    // Try to merge with tile to the right
    ...
    public boolean isGameOver() {
        ...
        for (int row = 0; row < size; row++) {
            for (int col = 0; col < size; col++) {
                ...
                // Check if any adjacent tiles can be merged (horizontal)
                if (col < size - 1 && grid[row][col + 1] != null && 
                    grid[row][col].getValue() == grid[row][col + 1].getValue()) {
                    return false;
                }
                
                // Check if any adjacent tiles can be merged (vertical)
