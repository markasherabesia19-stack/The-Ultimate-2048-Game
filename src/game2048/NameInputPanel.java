...
/**
 * NameInputPanel allows the player to enter their name before starting a new game.
 * Features an animated starry background, text field for name entry, and buttons to start the game or return to the main menu.
 */
public class NameInputPanel extends JPanel {
    ...
    private void startGameWithName() {
        ...
        if (playerName.isEmpty()) {
            // Use custom warning dialog instead of JOptionPane
    ...
    public void removeNotify() {
        ...
        System.out.println("NameInputPanel: Stopping animation timer");
    
        if (animationTimer != null && animationTimer.isRunning()) {
            animationTimer.stop();
            System.out.println("NameInputPanel timer stopped");
        }
    }
}